...
<template>
  <Link :href="href" class="group flex flex-col gap-3 rounded-2xl border border-gray-200 bg-white p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/5 dark:bg-gray-900">
    <div class="flex items-center justify-between">
      ...
      <span class="rounded-full bg-gray-100 px-3 py-1 text-xs font-semibold text-gray-600 ring-1 ring-gray-200 dark:bg-white/5 dark:text-gray-300 dark:ring-white/10"> Shortcut </span>
    </div>
    <div class="space-y-1">
