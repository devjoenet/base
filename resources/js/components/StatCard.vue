...
<template>
  <div
    class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm ring-1 ring-gray-100/60 dark:border-white/5 dark:bg-gray-900 dark:ring-white/5"
  >
    <div class="flex items-start gap-3">
      <div
        v-if="icon"
        class="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50 text-indigo-600 ring-1 ring-inset ring-indigo-100/80 dark:from-indigo-500/10 dark:to-blue-500/10 dark:text-indigo-300 dark:ring-indigo-500/30"
      >
