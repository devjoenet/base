  ...
  >
    <div :class="['relative isolate overflow-hidden rounded-xl p-4 shadow-sm', styles?.container]">
      <div class="flex items-start gap-3">
        ...
        <button type="button" class="inline-flex size-8 items-center justify-center rounded-lg text-sm font-medium ring-1 ring-inset ring-black/5 transition hover:bg-black/5 dark:ring-white/10 dark:hover:bg-white/5" @click="open = false" aria-label="Dismiss notification">
